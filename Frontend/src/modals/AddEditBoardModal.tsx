...
import { IColumn, ITask } from 'src/interfaces'
...
function AddEditBoardModal({ setIsBoardModalOpen, type }: { setIsBoardModalOpen: (act: boolean) => void; type: string }) {
  ...
  const onDelete = (id: string) => {
    setNewColumns((prevState) => prevState?.filter((el: INewCol) => el.id !== id))
  }
